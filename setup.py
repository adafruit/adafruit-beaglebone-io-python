...
setup(name='Adafruit_BBIO',
      ...
      ext_modules=[Extension('Adafruit_BBIO.GPIO', ['source/py_gpio.c', 'source/event_gpio.c', 'source/constants.c', 'source/common.c', 'source/softPwm.c', 'source/wiringBB.c', 'source/piHiPri.c'], extra_compile_args=['-Wno-format-security']),
